...
#define LKMDBG_EVENT_TARGET_SYSCALL_RULE_DETAIL 42
...
#define LKMDBG_SYSCALL_RULE_ACTION_REWRITE_ARGS 0x00000004U
#define LKMDBG_SYSCALL_RULE_ACTION_REWRITE_NR 0x00000008U
#define LKMDBG_SYSCALL_RULE_ACTION_REWRITE_RETVAL 0x00000010U

#define LKMDBG_SYSCALL_RULE_FLAG_ENABLED 0x00000001U
#define LKMDBG_SYSCALL_RULE_FLAG_ONESHOT 0x00000002U
#define LKMDBG_SYSCALL_RULE_ARG_MAX 6U
#define LKMDBG_SYSCALL_RULE_ARG_MASK_ALL 0x0000003fU
...
struct lkmdbg_syscall_rule_entry {
	...
	__u32 flags;
	__u32 priority;
	__u32 arg_match_mask;
	__u32 rewrite_mask;
	__u64 arg_values[LKMDBG_SYSCALL_RULE_ARG_MAX];
	__u64 arg_value_masks[LKMDBG_SYSCALL_RULE_ARG_MAX];
	__u64 rewrite_args[LKMDBG_SYSCALL_RULE_ARG_MAX];
	__s32 rewrite_syscall_nr;
	__u32 reserved1;
	__s64 retval;
	__u64 hits;
};
